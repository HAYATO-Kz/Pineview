...
const listOfInfo = [
  {
    header: 'เกี่ยวกับ :',
    description:
      'Pineview เป็นแอปพลิเคชันที่พัฒนาขึ้นเพื่อช่วยให้ ผู้ใช้งานหารีวิวของสถานที่ต่างๆ (ร้านอาหาร, คาเฟ, แหล่งท่องเที่ยว) ได้รวดเร็ว และสามารถอ่านรีวิวได้ ง่ายดายมากยิ่งขึ้น',
  },
  {
    header: 'ผู้สนับสนุน :',
    description:
